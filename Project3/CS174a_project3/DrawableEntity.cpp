...
bool DrawableEntity::loadPoints(vec3*& points, vec3*& normals , int num){ //Loads the passed points in the GPU memory and stores the name of the buffer and vertex array
    ...
    glBufferData(GL_ARRAY_BUFFER, num*sizeof(vec3)+num*sizeof(vec3), NULL, GL_STATIC_DRAW);
