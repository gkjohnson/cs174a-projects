...
//returns a size
//places all vertices in "points"
//places all normals in "normals"
//h_div is the number of horizontal divisions
//v_div is the number of vertical divisions
//smooth dictates the kind of normals the sphere has
